...
const vi = {
  ...
  profile: {
    title: "Hồ sơ của bạn",
    subtitle: "Thông tin cá nhân, quán đã lưu và khẩu vị",
    tabs: {
    ...
    removePhoto: "Gỡ ảnh",
    photoTooBig: "Ảnh quá lớn. Hãy chọn ảnh dưới 10 MB.",
    photoType: "Chỉ nhận ảnh PNG, JPEG hoặc WebP.",
    photoSaved: "Đã cập nhật ảnh đại diện.",
    levels: ["Thực khách mới", "Người nếm thử", "Thợ săn quán ngon", "Foodie chân chính"],
    levelHint: "Cấp độ tăng theo số đánh giá bạn viết",
    fullName: "Họ và tên",
    fullNamePlaceholder: "Ví dụ: Đào Duy Anh",
    usernameLabel: "Tên người dùng (hiện trên đánh giá)",
    email: "Email",
    emailLocked: "Email dùng để đăng nhập nên không đổi được.",
    homeCity: "Khu vực thường ăn",
    homeCityNone: "Chưa chọn",
    cities: { hanoi: "Hà Nội", hcmc: "TP. Hồ Chí Minh", danang: "Đà Nẵng" } as Record<string, string>,
    bio: "Giới thiệu ngắn",
    bioPlaceholder: "Ví dụ: Mê bún chả và cà phê trứng...",
    save: "Lưu thay đổi",
    saving: "Đang lưu...",
    cancel: "Hủy",
    saved_ok: "Đã cập nhật hồ sơ!",
    unsaved: "Bạn có thay đổi chưa lưu",
    savedEmpty: "Bạn chưa lưu quán nào. Bấm “Lưu” trên trang một quán để giữ lại ở đây.",
    savedNote: "Danh sách này lưu trên trình duyệt này.",
    unsave: "Bỏ lưu",
    browse: "Khám phá quán",
    reviewsEmpty: "Bạn chưa viết đánh giá nào.",
    deleteReview: "Xóa",
    deleteConfirm: "Xóa đánh giá này?",
    reviewDeleted: "Đã xóa đánh giá.",
    tastesTitle: "Món và kiểu quán bạn thích",
    tastesHint: "Chọn tối đa 12. Trợ lý AI dùng lựa chọn này để gợi ý câu hỏi cho bạn.",
    tastesLimit: "Tối đa 12 lựa chọn.",
    securityTitle: "Đổi mật khẩu",
    currentPassword: "Mật khẩu hiện tại",
    newPassword: "Mật khẩu mới",
    confirmPassword: "Nhập lại mật khẩu mới",
    passwordMismatch: "Hai mật khẩu mới chưa khớp.",
    passwordShort: "Mật khẩu mới cần ít nhất 8 ký tự.",
    changePassword: "Đổi mật khẩu",
    passwordChanged: "Đã đổi mật khẩu. Các thiết bị khác đã được đăng xuất.",
    passwordNote: "Sau khi đổi, mọi thiết bị khác sẽ bị đăng xuất; thiết bị này vẫn đăng nhập.",
    googleAccount: "Tài khoản này đăng nhập bằng Google nên không có mật khẩu riêng. Quản lý bảo mật trong tài khoản Google của bạn.",
    loginRequired: "Vui lòng đăng nhập để mở trang này.",
    loading: "Đang tải hồ sơ...",
  },

  authForm: {
    brandTagline: "Quán ngon quanh bạn, chọn theo đánh giá thật",
    tabLogin: "Đăng nhập",
    tabRegister: "Đăng ký",
    loginLead: "Đăng nhập để lưu quán ruột, viết đánh giá và hỏi trợ lý AI.",
    registerLead: "Tạo tài khoản trong 30 giây để nhận gợi ý quán hợp khẩu vị.",
    google: "Tiếp tục với Google",
    divider: "hoặc dùng email",
    username: "Tên người dùng",
    usernameHint: "Hiện trên các đánh giá của bạn. 3–30 ký tự: chữ không dấu, số, . - _",
    email: "Email",
    password: "Mật khẩu",
    ...
    strength: ["Quá ngắn", "Yếu", "Trung bình", "Mạnh"],
    errUsername: "Vui lòng nhập tên người dùng",
    errUsernameFormat: "3–30 ký tự, chỉ gồm chữ không dấu, số và . - _",
    errEmail: "Vui lòng nhập email",
    errInvalidEmail: "Email chưa đúng định dạng",
    errPassword: "Vui lòng nhập mật khẩu",
    errPasswordLength: "Mật khẩu cần ít nhất 8 ký tự",
    errGooglePassword:
      "Email này đã được đăng ký bằng mật khẩu. Vui lòng đăng nhập bằng mật khẩu thay vì Google.",
  ...
  rightNow: {
    ...
    picking: "Đang chọn cho bạn...",
    goThere: "Xem quán này",
  ...
  detail: {
    ...
    showLess: "Thu gọn",
    ask: {
      title: "Hỏi về quán này",
      sub: "Trả lời từ đánh giá thật và dữ liệu của quán",
      q: {
        food: "Món ăn có ngon không?",
        price: "Giá cả có hợp lý không?",
        service: "Phục vụ thế nào?",
        hygiene: "Có sạch sẽ không?",
        parking: "Có chỗ để xe không?",
        goodFor: "Hợp đi với ai?",
        hours: "Mấy giờ mở cửa?",
      },
      praised: "Thực khách khen {aspect}:",
      criticised: "Thực khách hay chê {aspect}:",
      mixed: "Ý kiến về {aspect} còn chia đôi:",
      share: "{percent}% trong {mentions} lượt nhắc là tích cực.",
      scoreIs: "Điểm tiêu chí này:",
      notEnough: "Chưa đủ đánh giá nhắc tới {aspect} để trả lời chắc chắn.",
      goodForIs: "Theo Foody, quán phù hợp cho:",
      noGoodFor: "Foody chưa ghi quán này phù hợp cho dịp nào.",
      hoursAre: "Giờ mở cửa:",
      priceIs: "Giá khoảng",
      noHours: "Quán chưa công bố giờ mở cửa.",
      similar: "Tìm quán tương tự",
      under100k: "dưới 100k",
    },
  ...
  chat: {
    ...
    searching: "Đang tìm quán...",
    slowServer: "Máy chủ đang khởi động, có thể mất tới một phút...",
    greetingReply: "Chào bạn! 👋 Bạn muốn ăn gì hôm nay? Cứ nói tên món, khu vực hay mức giá, ví dụ: bún bò ở Quận 3 dưới 60k.",
    inCity: "ngon ở",
    nearMe: "ngon gần đây",
    expandLabel: "Mở toàn màn hình",
    toBottom: "Xuống cuối",
...
const en: typeof vi = {
  ...
  profile: {
    title: "Your profile",
    subtitle: "Your details, saved places and tastes",
    tabs: {
    ...
    photoTooBig: "That image is too large. Choose one under 10 MB.",
    photoType: "Only PNG, JPEG or WebP images.",
    photoSaved: "Profile photo updated.",
    levels: ["New diner", "Taster", "Spot hunter", "True foodie"],
    levelHint: "Your level rises with the reviews you write",
    fullName: "Full name",
    fullNamePlaceholder: "e.g. Dao Duy Anh",
    usernameLabel: "Username (shown on your reviews)",
    email: "Email",
    emailLocked: "Your email is your sign-in, so it cannot be changed here.",
    homeCity: "Where you usually eat",
    homeCityNone: "Not set",
    cities: { hanoi: "Hanoi", hcmc: "Ho Chi Minh City", danang: "Da Nang" } as Record<string, string>,
    bio: "Short bio",
    bioPlaceholder: "e.g. Loves bun cha and egg coffee...",
    save: "Save changes",
    saving: "Saving...",
    cancel: "Cancel",
    saved_ok: "Profile updated!",
    unsaved: "You have unsaved changes",
    savedEmpty: "No saved places yet. Tap “Save” on a restaurant page to keep it here.",
    savedNote: "This list is kept in this browser.",
    unsave: "Remove",
    ...
    tastesTitle: "Dishes and places you like",
    tastesHint: "Pick up to 12. The AI assistant uses them to suggest questions for you.",
    tastesLimit: "Up to 12 choices.",
    securityTitle: "Change password",
    currentPassword: "Current password",
    newPassword: "New password",
    confirmPassword: "Repeat the new password",
    passwordMismatch: "The new passwords do not match.",
    passwordShort: "Use at least 8 characters for the new password.",
    changePassword: "Change password",
    passwordChanged: "Password changed. Your other devices have been signed out.",
    passwordNote: "Changing it signs out every other device; this one stays signed in.",
    googleAccount: "This account signs in with Google and has no password of its own. Manage its security in your Google account.",
    loginRequired: "Please log in to open this page.",
    loading: "Loading your profile...",
  },

  authForm: {
    brandTagline: "Great places to eat near you, ranked by real reviews",
    tabLogin: "Log in",
    tabRegister: "Sign up",
    loginLead: "Log in to save your favourite spots, write reviews and ask the AI assistant.",
    registerLead: "Create an account in 30 seconds to get suggestions that fit your taste.",
    google: "Continue with Google",
    divider: "or use email",
    username: "Username",
    usernameHint: "Shown on your reviews. 3–30 characters: letters, numbers, . - _",
    email: "Email",
    password: "Password",
  ...
  rightNow: {
    ...
    again: "Pick another",
    pickBadge: "Our pick",
    picking: "Picking one for you...",
    goThere: "See this place",
  ...
  detail: {
    ...
    ask: {
      ...
      sub: "Answered from real reviews and the restaurant's own data",
      q: {
        food: "Is the food good?",
        price: "Is it good value?",
        service: "How is the service?",
        hygiene: "Is it clean?",
        parking: "Is there parking?",
        goodFor: "Who is it good for?",
        hours: "When is it open?",
      },
      praised: "Diners praise the {aspect}:",
      criticised: "Diners often criticise the {aspect}:",
      mixed: "Opinions on the {aspect} are split:",
      share: "{percent}% of {mentions} mentions are positive.",
      scoreIs: "Score for this criterion:",
      notEnough: "Not enough reviews mention the {aspect} to say.",
      goodForIs: "Foody lists it as good for:",
      noGoodFor: "Foody does not list what occasions it suits.",
      hoursAre: "Open:",
      priceIs: "Prices around",
      noHours: "Opening hours are not listed.",
      similar: "Find similar places",
  ...
  chat: {
    ...
    searching: "Looking for places...",
    slowServer: "The server is waking up; this can take up to a minute...",
    greetingReply: "Hi there! 👋 What would you like to eat? Tell me a dish, an area or a budget, e.g. bun bo in District 3 under 60k.",
    inCity: "in",
    nearMe: "near me",
