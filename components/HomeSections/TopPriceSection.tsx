...
import { getTopPriceRestaurants } from "@/app/lib/api";
...
const TopPriceSection = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getTopPriceRestaurants(10);
        setRestaurants(data);
      } catch (error) {
        console.error("Failed to fetch top price:", error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <section className="top-rating-section">
      <div className="container">
        <div className="section-header-row">
          <div>
            <h2 className="section-title">{T.home.priceTitle}</h2>
            <p className="section-subtitle">{T.home.priceSub}</p>
          </div>
              ...
              <div className="modal-layout">
                ...
                <div className="modal-info-col">
                  ...
                  <div className="rating-bars">
                    <RatingRow label={T.restaurantPage.labels.price} score={selectedRes.diemGiaCa} highlight={true} color="#00b894"/>
...
export default TopPriceSection;